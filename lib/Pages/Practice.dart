...
import 'ChatApp/GetxApp/controller.dart';

class PracappGetx extends StatefulWidget {
  const PracappGetx({Key? key}) : super(key: key);

  @override
  State<PracappGetx> createState() => _PracappGetxState();
}

class _PracappGetxState extends State<PracappGetx> {
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child:
                                          ...
                                          future: myController
                                              .generateThumbnail(myController
                                                  .jsondata1
                                                  .value[index]["preMsg"]!),
                                ...
                                if (myController.jsondata1.value[index]
                                  ...
                                  InkWell(
                                    ...
                                    myController.jsondata1.value[index]
                                        ...
                                        '')
                                  Image.file(
                                    File(myController.jsondata1.value[index]
                                        ["preMsg"]!),
                                    width: 80,
                                    height: 80,
                                  )
  ...
  //   myController.scrollController.animateTo(
  //       myController.scrollController.position.maxScrollExtent,
