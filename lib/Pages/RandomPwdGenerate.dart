...
class RandomPwdGenerate extends StatefulWidget {
  @override
  _RandomPwdGenerateState createState() => _RandomPwdGenerateState();
}

class _RandomPwdGenerateState extends State<RandomPwdGenerate> {
